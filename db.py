...
def insert_item(form_data, current_user):
    ...
    # Build the parameters tuple from form_data and current_user
    params = (
        form_data['name'],                        # product_name in DB, 'name' in form_data
        form_data.get('description', ''),        # optional description
        ...
        current_user.username,                    # seller username from logged-in user
